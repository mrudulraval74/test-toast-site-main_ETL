...
import { Database, Lightbulb, Lock, AlertCircle } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/10 p-8">
            <div className="max-w-7xl mx-auto">
                <header className="mb-8">
                    ...
                    {/* Helpful Tips */}
                    <Alert className="ml-16 bg-primary/5 border-primary/20">
                ...
                <div className="bg-card/50 backdrop-blur-sm rounded-2xl shadow-xl border border-border/50 p-6 relative overflow-hidden group">
