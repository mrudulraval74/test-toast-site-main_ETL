...
import { Wand2, Save, Play, Loader2, FileCode, Folder, ChevronRight, ChevronDown, FileText, Trash2, Database, AlertTriangle, History, Code2, Lightbulb } from 'lucide-react';
...
export default function QueryBuilder() {
    ...
    const handleRunPreview = async () => {
        ...
        setPreviewResults({ columns: ['status'], rows: [{ status: 'Starting query execution...' }] });
        ...
        try {
            ...
            if (previewData && previewData.rows) {
                ...
                toast({
                    ...
                    description: `Fetched ${previewData.rows?.length || 0} rows.`,
                });
            ...
            setLoadingPreview(false);
            setPreviewResults(null);
            const msg = err instanceof Error ? err.message : 'Unknown error during preview';
            toast({
                title: 'Error',
                description: msg,
                variant: 'destructive',
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <Button
                                        ...
                                        title="Execute query and preview results (Ctrl+Enter)"
                                    >
                                        {loadingPreview ? (
