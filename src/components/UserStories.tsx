...
export const UserStories = ({ onViewChange, projectId }: UserStoriesProps) => {
    ...
    try {
      ...
      if (
        ...
        try {
          ...
          const response = await fetch(`${FUNCTIONS_BASE_URL}/jira-integration`, {
            method: "POST",
            headers: {
      ...
      if (
        ...
        try {
          ...
          const response = await fetch(
            `https://qfjeicrvelgmyyecvlxo.supabase.co/functions/v1/azure-devops-integration`,
            {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
  ...
  const fetchAvailableSprints = async () => {
    ...
    try {
      if (selectedBoardInfo.source === "jira" && savedConfigs.jira?.enabled) {
        ...
        const response = await fetch(`https://qfjeicrvelgmyyecvlxo.supabase.co/functions/v1/jira-integration`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        const response = await fetch(`https://qfjeicrvelgmyyecvlxo.supabase.co/functions/v1/azure-devops-integration`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
  ...
  const generateTestCases = async (storyId: string, customPrompt?: string, imageFiles?: File[]) => {
    ...
    try {
      ...
      const response = await fetch(`https://qfjeicrvelgmyyecvlxo.supabase.co/functions/v1/generate-test-cases`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
