...
import { Upload, Download, Zap, FileText, BarChart3, CheckCircle, AlertTriangle, TestTube, Brain, Eye, Trash2, FileDown, History, Clock, Activity, TrendingUp, RefreshCw, GitCompare } from "lucide-react";
import { ExecutionComparison } from "@/components/performance-testing/ExecutionComparison";
...
<jmeterTestPlan version="1.2" properties="5.0" jmeter="5.4.1">
  ...
  useEffect(() => {
    if (activeMainTab === "execution-history" && projectId) {
  ...
  const fetchExecutionHistory = async () => {
    ...
    try {
      const { data, error } = await supabase
        ...
        .select('id, job_id, agent_id, status, created_at, summary')
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Tabs value={activeMainTab} onValueChange={setActiveMainTab} className="w-full">
        <TabsList className="grid w-full grid-cols-3">
          ...
          <TabsTrigger value="execution-history" className="flex items-center gap-2">
        ...
        <TabsContent value="execution-history" className="space-y-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-muted-foreground">View past performance test execution results</p>
            </div>
            <div className="flex gap-2">
              <Button 
                ...
                disabled={executionHistory.filter(e => e.summary && e.status === 'completed').length < 2}
              >
                <GitCompare className="h-4 w-4 mr-2" />
                {showComparison ? 'Hide Comparison' : 'Compare Executions'}
              </Button>
              <Button 
                variant="outline" 
                size="sm" 
          ...
          {showComparison && executionHistory.length >= 2 && (
            <ExecutionComparison 
          ...
          {isLoadingHistory ? (
            ...
            <Card>
              <CardContent className="py-16 text-center">
                ...
                <h3 className="text-lg font-medium mb-2">No Execution Results Yet</h3>
                <p className="text-muted-foreground">
                  Execute a performance test to see results here
                </p>
              </CardContent>
            </Card>
          ) : (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <Card className="lg:col-span-2">
                <CardHeader>
                  ...
                  <CardDescription>
                    {selectedExecution 
                      ? `Executed on ${new Date(selectedExecution.created_at).toLocaleDateString()}` 
                ...
                <CardContent>
                  {selectedExecution ? (
                        ...
                        <>
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div className="p-4 bg-muted/50 rounded-lg text-center">
                              ...
                              <p className="text-2xl font-bold">{selectedExecution.summary.errorRate}%</p>
                            ...
                            <Table>
                              ...
                              <TableBody>
                                <TableRow>
                                  ...
                                  <TableCell className="text-right font-medium">{selectedExecution.summary.minResponseTime}ms</TableCell>
                                </TableRow>
                                <TableRow>
                                  <TableCell>Maximum</TableCell>
                                  <TableCell className="text-right font-medium">{selectedExecution.summary.maxResponseTime}ms</TableCell>
                                </TableRow>
                                <TableRow>
                                  <TableCell>Average</TableCell>
                                  <TableCell className="text-right font-medium">{selectedExecution.summary.avgResponseTime}ms</TableCell>
                                </TableRow>
                                <TableRow>
                                  <TableCell>P90</TableCell>
                                  <TableCell className="text-right font-medium">{selectedExecution.summary.p90ResponseTime}ms</TableCell>
                                </TableRow>
                                <TableRow>
                                  <TableCell>P95</TableCell>
                                  <TableCell className="text-right font-medium">{selectedExecution.summary.p95ResponseTime}ms</TableCell>
                                </TableRow>
                                <TableRow>
                                  <TableCell>P99</TableCell>
                                  <TableCell className="text-right font-medium">{selectedExecution.summary.p99ResponseTime}ms</TableCell>
                                </TableRow>
                              </TableBody>
                            </Table>
                          </div>
                          ...
                          <div className="grid grid-cols-2 gap-4 text-sm">
                            <div className="p-3 bg-muted/30 rounded-lg">
                              ...
                              <span className="ml-2 font-medium">{(selectedExecution.summary.totalBytes / 1024).toFixed(2)} KB</span>
                            </div>
                            <div className="p-3 bg-muted/30 rounded-lg">
                              <span className="text-muted-foreground">Job ID:</span>
                              <span className="ml-2 font-mono text-xs">{selectedExecution.job_id.slice(0, 8)}...</span>
                            </div>
                          </div>
                        </>
                      )}
                    ...
                    <div className="h-[400px] flex items-center justify-center text-muted-foreground border rounded bg-muted/20">
                      <div className="text-center space-y-2">
                        <Activity className="h-16 w-16 mx-auto opacity-30" />
                        <p className="text-lg">Select an execution to view details</p>
                        <p className="text-sm">Click on an execution from the list</p>
                      </div>
                    </div>
                  )}
                </CardContent>
